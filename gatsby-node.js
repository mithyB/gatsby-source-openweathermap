      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            apiUrl = `https://api.openweathermap.org/data/2.5/${options.type}?q=${options.location}&units=${options.units}&appid=${options.apikey}`;
            _context.next = 5;
            return fetch(apiUrl);
          ...
          case 8:
            data = _context.sent;
            createNode(_objectSpread(_objectSpread({}, data), {}, {
